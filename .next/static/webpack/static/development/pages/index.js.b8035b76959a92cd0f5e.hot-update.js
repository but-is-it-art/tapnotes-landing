...
function Hero() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("section", {
  ...
  }, "The reimagined Dental Record"), __jsx("section", {
    className: "grid gap-5 grid-cols-1 pb-12 md:gap-10 md:grid-cols-12 md:pb-32",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24,
    ...
    className: "col-start-3 col-end-6 max-w-md",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26,
    ...
    className: "col-start-7 col-end-10 column  max-w-md",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28,
  ...
  }, "notes done 80% faster with legal accuracy"), " while fully educating the patient."))));
}
...
//# sourceMappingURL=index.js.b8035b76959a92cd0f5e.hot-update.js.map