...
function Standalone() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("section", {
    ...
    className: "bg-lightestgray grid gap-5 grid-cols-1 pb-12 md:gap-10 md:grid-cols-12 md:pb-16",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6,
    ...
    className: "bg-aurablue hover:bg-blue-700 text-white rounded-full ml-4",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13,
...
//# sourceMappingURL=index.js.b21b620f19de0240e3f0.hot-update.js.map